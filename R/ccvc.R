...
#' @return A named imlist of \pkg{SpatStat} \code{im} objects containing the centred covariance estimates from the different methods.
#'  
#' 
...
#' @details 
#' Computes centred covariance using \code{balancedcovariances}. See help file for \code{balancedcovariances} for available methods.
